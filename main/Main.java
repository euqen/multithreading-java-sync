...
public class Main {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Ship ship1 = new Ship("Abraham Linkoln", port, 90);
		...
		Ship ship2 = new Ship("Black Pearl", port, 90);
		...
		Ship ship3 = new Ship("Espan'jola", port, 90);
